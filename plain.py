...
class PlainBlock(nn.Module):
    """Plain Block tanpa residual connection"""
    ...
    def forward(self, x):
        ...
        if self.downsample is not None:
            _ = self.downsample(x)  # hanya untuk konsistensi dimensi
        return F.relu(out)

class Plain34(nn.Module):
    """Plain-34 mirip ResNet-34 tapi tanpa residual"""
    def __init__(self, num_classes=5):
        ...
        self.stage1 = self._make_stage(64, 64, 3, 1)
        self.stage2 = self._make_stage(64, 128, 4, 2)
        self.stage3 = self._make_stage(128, 256, 6, 2)
    ...
    def _make_stage(self, in_channels, out_channels, num_blocks, stride):
        ...
        layers += [PlainBlock(out_channels, out_channels) for _ in range(1, num_blocks)]
...
if __name__ == "__main__":
    ...
    SAVE_DIR = Path("/content/drive/MyDrive/Competitive Deep Learning/plain_result")
    ...
    # Model
    model = create_plain34(num_classes=num_class).to(device)
